# Simple SPIRE 1.5.0 deployment using PSAT node attestor

This configuration is an example of a simple SPIRE 1.5.0 deployment for Kubernetes that uses [PSAT node attestor](https://github.com/spiffe/spire/blob/v1.5.0/doc/plugin_server_nodeattestor_k8s_psat.md).
