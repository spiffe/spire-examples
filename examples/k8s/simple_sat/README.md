...
This configuration is an example of a simple SPIRE v1.0.1 deployment for Kubernetes that uses [SAT node attestor](https://github.com/spiffe/spire/blob/v1.0.1/doc/plugin_server_nodeattestor_k8s_sat.md).
