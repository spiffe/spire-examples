...
curl -L -o spire.tgz https://github.com/spiffe/spire/releases/download/v1.10.4/spire-1.10.4-linux-amd64-musl.tar.gz
tar -xvf spire.tgz
mv spire-*/bin/spire-agent /bin
curl -L -o step.tgz https://dl.smallstep.com/gh-release/cli/gh-release-header/v0.27.4/step_linux_0.27.4_amd64.tar.gz
tar -xvf step.tgz
