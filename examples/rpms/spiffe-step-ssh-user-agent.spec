...
License:    Apache-2.0
URL:        https://spiffe.io
Source0:    https://github.com/spiffe/spiffe-step-ssh/releases/download/v%{version}/spiffe-step-ssh_Linux_%{ARCH}.tar.gz
%global __strip /bin/true

%description
SPIFFE step-ca ssh user agent
...
cp -a spiffe-step-ssh-user-agent %{buildroot}/usr/bin

%clean
rm -rf %{buildroot}

%files
/usr/bin/spiffe-step-ssh-user-agent
